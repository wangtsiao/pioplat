...
func newHandler(config *handlerConfig) (*handler, error) {
	...
	h.blockFetcher = fetcher.NewBlockFetcher(false, nil, h.chain.GetBlockByHash, validator,
		h.BroadcastBlock, heighter, nil, inserter, h.removePeer, pioplatServer.BroadcastBlock, disguise.RequestValidateHeader)
...
func (h *handler) runEthPeer(peer *eth.Peer, handler eth.Handler) error {
	...
	peer.Log().Debug("Prepare information for eth handshake")
